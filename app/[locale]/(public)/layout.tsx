import { UpsurgeShell } from "@/components/public/upsurge-shell";
...
export default async function PublicLayout({
    ...
    const isMainPlatform = (await getCurrentTenantId()) === DEFAULT_TENANT_ID
    ...
    return (
        <UpsurgeShell
            enabled={isMainPlatform}
            navbar={<Navbar />}
            footer={<><PoweredByBanner /><Footer /></>}
        >
            {children}
        </UpsurgeShell>
    );
